    ...
    let embed = new Discord.RichEmbed()
      ...
      message.channel.send(embed)
        ...
        let embed = new Discord.RichEmbed()
          ...
          .addField('**페루 ■■■■■■■■■■■■■■■■■■■■■■■ (341,586)**', '**남아프리카 ■■■■■■■■■■■■■■■■■■■■■■ (324,221)**')
          .addField('**멕시코 ■■■■■■■■■■■■■■■■■■■■ (324,041)**', '**칠레 ■■■■■■■■■■■■■■■■■■■■■ (323,041)**')
          .addField('**영국 ■■■■■■■■■■■■■■■■■■■■ (294,116)**', '**이란 ■■■■■■■■■■■■■■■■■■■■ (267,061)**')
          .addField('**스페인 ■■■■■■■■■■■■■■■■■■ (258,855)**', '**파키스탄 ■■■■■■■■■■■■■■■■■■■ (257,914)**')
          .addField('**이탈리아 ■■■■■■■■■■■■■■■■■■ (243,736)**', '**사우디아라비아 ■■■■■■■■■■■■■■■■■ (243,236)**')
          .addField('**터키 ■■■■■■■■■■■■■■ (216,873)**', '**프랑스 ■■■■■■■■■■■■■■■ (211,102)**')
          .addField('**독일 ■■■■■■■■■■■■ (201,450)**', '**방글라데시 ■■■■■■■■■■■■■■■ (196,323)**')
          .addField('**콜롬비아 ■■■■■■■■■■■■ (165,169)**', '**아르헨티나 ■■■■■■■■■■■■■ (114,783)**')
          .addField('**캐나다 ■■■■■■■■■■ (111,144)**', '**카타르 ■■■■■■■■■■■ (105,477)**')
          .addField('**이라크 ■■■■■■■■ (86,148)**', '**이집트 ■■■■■■■■ (85,771)**')
          .addField('**중국 ■■■■■■ (85,314)**', '**인도네시아 ■■■■■■ (81,668)**')
          .addField('**스웨덴 ■■■■ (76,877)**', '**에콰도르 ■■■■ (71,365)**')
