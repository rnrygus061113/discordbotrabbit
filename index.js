...
client.on('message', (message) => {
  ...
  if(message.content == '!날씨') {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .addField('**온도**', '최저 19도\n최고26도', true)
      .addField('**체감온도**', '26.2도', true)
      .addField('**습도**', '최저 50도\n최고90도', true)
      .addField('**날씨**', '흐림', true)
      .addField('**미세먼지**', '보통(37)', true)
      .addField('**초미세먼지**', '좋음(4)', true)
      .setColor('#F5FF00')
      .setFooter('2020년 07월 15일 기준입니다', img)
      ...
      message.channel.send(embed)
        ...
        let embed = new Discord.RichEmbed()
          ...
          .addField('**최신 데이터**', '해당 자료는 2020년 7월 15일 00시 기준 자료입니다.')
          .addField('**확진환자(누적)**', '13,551(+ 39)', true)
          .addField('**완치환자(격리해제)**', '12,348(+ 66)', true)
          .addField('**치료중(격리 중)**', '913(- 27)', true)
          .addField('**사망**', '289(+ 0)', true)
          .addField('**누적확진률**', '1.0 %', true)
          .addField('**치사율**', '2.13 %', true)
          .addField('**- 최신 브리핑 1 : 코로나바이러스감염증-19 중앙재난안전대책본부 정례브리핑 (2020년 7월 15일)**', '링크 : http://ncov.mohw.go.kr/tcmBoardView.do?contSeq=355427')
          .addField('**- 최신 브리핑 2 : 코로나바이러스감염증-19 국내 발생 현황 (2020년 7월 15일)**', '링크 : http://ncov.mohw.go.kr/tcmBoardView.do?contSeq=355424')
          .setColor('#6799FF')
      ...
      message.channel.send(embed)
        ...
        let embed = new Discord.RichEmbed()
          ...
          .addField('**2020/07/15 11:54:13 재난문자 [종로구청]**', '[종로구청]타지역 확진자 관내 이동 동선등 홈페이지,블로그공개.방역완료.거리두기,마스크착용 등 방역수칙준수바랍니다 blog.naver.com/jongno0401')
          .addField('**2020/07/15 11:52:13 재난문자 [평창군청]**', '[평창군청] 대관령면 주민 해외입국자 자가격리기간 중 추가검사에서 코로나19 확진판정. 접촉자 없음. 주민들은 외출 시 마스크 착용 생활화 해주시기 바랍니다.')
          .addField('**2020/07/15 11:49:17 재난문자 [미추홀구청]**', '[미추홀구청]확진자1명발생(해외입국자-우즈벡,자가격리중,주안8동)자택 및 주변 방역완료,세부내용 홈페이지게시http://michu.incheon.kr/corona')
