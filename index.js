    ...
    let embed = new Discord.RichEmbed()
      ...
      message.channel.send(embed)
        ...
        let embed = new Discord.RichEmbed()
          ...
          .addField('**미국   ■■■■■■■■■■■■■■■■■■■■■■■■■ (3,576,156)**', '**브라질 ■■■■■■■■■■■■■■■■■■■■■■■■■ (2,012,151)**')
          .addField('**인도   ■■■■■■■■■■■■■■■■■■■■■■■■ (968,876)**', '**러시아 ■■■■■■■■■■■■■■■■■■■■■■■■ (751,612)**')
          .addField('**페루   ■■■■■■■■■■■■■■■■■■■■■■■ (341,586)**', '**남아프 ■■■■■■■■■■■■■■■■■■■■■■ (324,221)**')
          .addField('**멕시코 ■■■■■■■■■■■■■■■■■■■■ (324,041)**', '**칠레  ■■■■■■■■■■■■■■■■■■■■■ (323,041)**')
          .addField('**영국   ■■■■■■■■■■■■■■■■■■■■ (294,116)**', '**이란   ■■■■■■■■■■■■■■■■■■■■ (267,061)**')
          .addField('**스페인 ■■■■■■■■■■■■■■■■■■ (258,855)**', '**파키스 ■■■■■■■■■■■■■■■■■■■ (257,914)**')
          .addField('**이탈리 ■■■■■■■■■■■■■■■■■■ (243,736)**', '**사우디 ■■■■■■■■■■■■■■■■■ (243,236)**')
          .addField('**터키   ■■■■■■■■■■■■■■ (216,873)**', '**프랑스 ■■■■■■■■■■■■■■■ (211,102)**')
          .addField('**독일   ■■■■■■■■■■■■ (201,450)**', '**방글라 ■■■■■■■■■■■■■■■ (196,323)**')
          .addField('**콜롬비 ■■■■■■■■■■■■ (165,169)**', '**아르헨 ■■■■■■■■■■■■■ (114,783)**')
          .addField('**캐나다 ■■■■■■■■■■ (111,144)**', '**카타르 ■■■■■■■■■■■ (105,477)**')
          .addField('**이라크 ■■■■■■■■ (86,148)**', '**이집트 ■■■■■■■■ (85,771)**')
          .addField('**중국   ■■■■■■ (85,314)**', '**인도네 ■■■■■■ (81,668)**')
          .addField('**스웨덴 ■■■■ (76,877)**', '**에콰도 ■■■■ (71,365)**')
          .addField('**벨로루 ■■ (65,623)**', '**카자흐 ■■ (65,188)**')
          .addField('**벨기에 ■ (63,039)**', '**총합**: 13,767,548')
